        ...
        public void PayDrink(int drinkSelection)
        {
            ...
            try
            {
                switch (drinkSelection)
                {
                    case 1:
                        Console.WriteLine();
                        Console.WriteLine("PRICE FOR --> " + coca.drinkName + " " + coca.drinkPrice + " €");
                        Console.WriteLine();
                    ...
                    case 2:
                        Console.WriteLine();
                        Console.WriteLine("PRICE FOR --> " + fanta.drinkName + " " + fanta.drinkPrice + " €");
                        Console.WriteLine();
                        selectedCoinValue = SelectedCoin();
                    ...
                    case 3:
                        Console.WriteLine();
                        Console.WriteLine("PRICE FOR --> " + sprite.drinkName + " " + sprite.drinkPrice + " €" );
                        Console.WriteLine();
                        selectedCoinValue = SelectedCoin();
